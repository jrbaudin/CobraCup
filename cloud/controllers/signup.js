            ...
            teamQuery.find().then(function(teams) {
              if (teams) {
                Mailgun.sendEmail({
                  ...
                  html: "<html><h3>Din anmälan till Cobra Cup 2015 är klar!</h3> <p>Det här är ett automatiskt genererat mail som går ut till dig som lagkapten. Syftet är att meddela att er anmälan har gått igenom. Kom ihåg, Cobra Cup sker den 22 december 2014. Vi ses där!</p><p>Dina uppgifter är:<br> Kapten: <b>" + captain_name + "</b><br>Assisterande: <b>" + lieutenant_name + "</b><br>Lagnamn: <b>" + team_name + "</b><br><br>Ditt lösenord är <b>" + pass + "</b></p><p><h3>Viktig information</h3>Som ni kanske sett så är det i år en anmälningsavgift för att vara med i Cobra Cup. Denna avgift är till för att täcka hyra av lokal, middag till alla deltagare samt priser.<br>Denna avgift ligger på <b>150 kr</b> per person och ska vara betald en vecka innan Cobra Cup dvs. 15 december 2014. <b>Obs.</b> Om denna avgift på 150 kr /person (300 kr /lag) <u>inte</u> är betald i tid tappar laget sin plats i turneringen.<br><br>Betalning sker enklast via Swish till <b>070 566 64 21</b>. Märk din betalning med lagnamn.<br>Om du/ni inte har Swish eller inte vill använda er av det ber jag er kontakta mig för att få kontonummer.<br><br>Om det är några frågor tveka inte att kontakta oss på joel@cobracup.se.</p><p>Tack för att du använder dig av denna sida och framförallt, tack för att ni vill vara med i Cobra Cup!<br><br>Med vänlig hälsning<br>Joel & David<br>www.cobracup.se</p></html>"
                }, {
